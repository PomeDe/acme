...
<li className="mt-2 flex text-black dark:text-white"><a className="w-full text-sm underline-offset-4 hover:underline dark:hover:text-neutral-100 underline" href="/search/stickers">Stickers</a></li>
