        ...
        <div className="flex justify-between items-center h-20 w-11/12">
            <div className="flex items-center space-x-8">
                ...
                <div className="flex space-x-4 text-neutral-400">
                    ...
                    <Link href="#" className="hover:underline">Shirts</Link>
...
<li className="mt-2 flex text-black dark:text-white"><a className="w-full text-sm underline-offset-4 hover:underline dark:hover:text-neutral-100 underline" href="/search/shirts">Shirts</a></li>
